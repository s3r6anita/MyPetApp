...
fun UpdateProcedureScreen(navController: NavHostController, context: Context) {
    ...
    Scaffold(
        ...
        Column(
            ...
            var selectedType by remember { mutableStateOf(mutableProc.type.type) }
...
//                    colors = ExposedDropdownMenuDefaults.textFieldColors()
            ...
            var selectedName by remember { mutableStateOf(mutableProc.type.name) }
...
//                    colors = ExposedDropdownMenuDefaults.textFieldColors()
            ...
            var frequencyString by remember { mutableStateOf(mutableProc.frequency.toString()) }
            ...
            var isDone by remember { mutableStateOf(mutableProc.isDone) }
            ...
            // уведомление
            var enableNotifications by remember { mutableStateOf(mutableProc.settings.isReminderEnabled) }
            var timeNotificationString by remember { mutableStateOf(mutableProc.settings.beforeReminderTime.toString()) }
                ...
                onClick = {
                    try {
                        ...
                        procedures[0].let { // TODO поменять индекс
                            ...
                            it.dateDone = mutableProc.dateDone
                            it.timeDone = mutableProc.timeDone
                            it.notes = mutableProc.notes
                            it.settings.isReminderEnabled = mutableProc.settings.isReminderEnabled
                            it.settings.beforeReminderTime = mutableProc.settings.beforeReminderTime
                        }
